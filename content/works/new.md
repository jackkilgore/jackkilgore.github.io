...
<iframe class="w-80" style="aspect-ratio: 16 / 9; border: 0;" src="https://www.youtube.com/embed/rvTHbmTpgdU" title="new - 2.3.0" frameborder="0" allowfullscreen></iframe>

### 2.3.0 - Changelog

_2.2.1-2.2.3_

- more intense panning phrases through the piece
- small noise floor ramps across phrase 6-10
- more extreme pitch shifts on phrases 6, 8
- more conservative use of pitch shift in phrases 1-4
- turn down max volume of ramps in phases 1, 3 when phase is sync'd
- more variation on pitch bend ramps:
  - use of (con + con) / (div + div) pattern in phrase 8, 9
- break out beeps into separate track
- raise volume of beeps in phrases 3, 4
- beeps gain stage 0db to +1.5db
- beeps fast compressor + phrasing on threshold to control peaks
- peak catcher on the master (-4db threshold, 2db knee, 100:1 ratio, instant attack, 10ms release, 20ms lookahead)
- bass gain stage +3db to +5db
- hi gain stage +3db to +3.5db
- lengthen tail of final sub note

### 2.2.0 - Changelog

- phase lock synths
- bass gain stage +2db
- attack 0.0 ms become 0.2 ms
- panning phrases
- phrases 3 and 4 get beeps
- hi phrase
